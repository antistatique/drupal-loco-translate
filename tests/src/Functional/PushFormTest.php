...
/**
 * @coversDefaultClass \Drupal\loco_translate\Form\PushForm
 *
 * @group loco_translate
 * @group loco_translate_browser
 * @group kevin
 */
class PushFormTest extends BrowserTestBase {
  ...
  public function testAccessPermission() {
    ...
    $account = $this->drupalCreateUser(['push using loco translate']);
    $this->drupalLogin($account);
